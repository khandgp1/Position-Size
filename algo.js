/**
 * Calculates position size for a BTC long or short trade.
 *
 ...
 * @returns {{ positionSize: number, positionUnitSize: number, actualRisk: number, leverage: number, liquidationPrice: number, initialMargin: number, direction: 'long' | 'short' } | null}
